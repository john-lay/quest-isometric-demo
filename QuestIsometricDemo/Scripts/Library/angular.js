 ...
 * @module ng
 * @description
 * GetAll the testability service for the instance of Angular on the given
 * element.
 * @param {DOMElement} element DOM element which is the root of angular application.
 */
...
function $CacheFactoryProvider() {
   ...
   *
   * @description
   * GetAll information about all the caches that have been created
   *
   ...
   *
   * @description
   * GetAll access to a cache object by the `cacheId` used when it was created.
   *
  ...
  this.$$parse = function(url) {
    ...
    function removeWindowsDriveName(path, url, base) {
      ...
      */
      ...
      //GetAll the relative path from the input URL.
